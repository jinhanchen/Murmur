 ...
 */
async overlayAck(label: string) : Promise<void> {
    await TAURI_INVOKE("overlay_ack", { label });
},
 ...
 */
async ollamaStatus() : Promise<Result<OllamaStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("ollama_status") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async ollamaListModels() : Promise<Result<string[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("ollama_list_models") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async ollamaPullModel(model: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("ollama_pull_model", { model }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type OllamaStatus = { running: boolean; 
/**
