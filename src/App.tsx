...
function App() {
  ...
  // First-run: open the onboarding wizard once the main app is reachable.
  // Persistence is a localStorage flag so we never re-nag after skip/finish.
  useEffect(() => {
  ...
  const handleAccessibilityComplete = () => {
    // Permissions granted → main app. The onboarding wizard (hardware scan +
    // model + LLM + tutorial) opens as a modal over the home page for new users.
    setOnboardingStep("done");
  };
